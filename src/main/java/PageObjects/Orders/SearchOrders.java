...
public class SearchOrders extends GeneralPage {
    ...
    private final By _txtSearchOrders = By.xpath("//input[@placeholder='Search orders...']");

    public WebElement getsltSearch() { return Constant.WEBDRIVER.findElement(_sltSearch);}
    public WebElement gettxtSearchOrders() { return Constant.WEBDRIVER.findElement(_txtSearchOrders);}
